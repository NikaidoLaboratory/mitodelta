...
my $bwa = $User_Preferences->{bwa};   #20241126added
my $star = $User_Preferences->{star}; #20241204added
my $lastal = $User_Preferences->{lastal};
my $lastsp = $User_Preferences->{lastsp};
my $mfcv = $User_Preferences->{mfcv};
my $blastn = $User_Preferences->{blastn};         #20241208added
my $blasttomaf = $User_Preferences->{blasttomaf}; #20241208added
my $python = $User_Preferences->{python};         #20241208added
...
my $seqtk = $User_Preferences->{seqtk}; #20241208added

#DATABASES
my $hsindex = $User_Preferences->{hsindex};
my $bwindex = $User_Preferences->{bwindex}; #20241126added
my $stindex = $User_Preferences->{stindex}; #20241204added
my $faindex = $User_Preferences->{faindex};
my $lastindex = $User_Preferences->{lastindex};
my $blastdb = $User_Preferences->{blastdb}; #20241208added
