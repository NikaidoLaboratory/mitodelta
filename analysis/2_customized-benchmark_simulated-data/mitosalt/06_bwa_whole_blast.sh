...
#SBATCH --output=./06_bwa_whole_blast/out.txt
#SBATCH --error=./06_bwa_whole_blast/err.txt
#SBATCH --nodes=1
...
script="/home/hrknkg/mitosalt/MitoSAlt_custom_241227/MitoSAlt_SE1.1.1_BWA_blast_breakspan.pl"
fastqs="/home/hrknkg/flux/250410_flux20del_80error/2_merge_wt_del_500K"
outdir="indel.BWA.whole.BLAST"
