...
#SBATCH --output=./01_hisat_mt_last/out.txt
#SBATCH --error=./01_hisat_mt_last/err.txt
#SBATCH --nodes=1
...
config="/home/hrknkg/mitosalt/MitoSAlt_custom_241227/config_mouse_mt_last.txt"
script="/home/hrknkg/mitosalt/MitoSAlt_custom_241227/MitoSAlt_SE1.1.1_HISAT_last_breakspan.pl"
fastqs="/home/hrknkg/flux/250410_flux20del_80error/2_merge_wt_del_500K"
outdir="indel.HISAT.mt.LAST"
