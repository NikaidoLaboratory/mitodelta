...
#SBATCH --output=./1_map_benchmark/out.txt
#SBATCH --error=./1_map_benchmark/err.txt
#SBATCH --nodes=1
...
apptainer exec --bind $HOME:$HOME --pwd $PWD ../splicebreak-env_1.0.0.sif\
 $sbpath/Splice-Break2_single-end.sh $fastqs $outdir $outdir/log $sbpath --align=yes --ref=mouse --skip_preAlign=yes
