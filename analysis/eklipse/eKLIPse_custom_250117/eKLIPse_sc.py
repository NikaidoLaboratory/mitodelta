...
def SC_blast(titleBam,dicoInit,lstError):
    try:
        ...
        pathSCfasta = os.path.join(dicoInit['pathTmpDir'],titleBam+".fasta")
        pathMAF = os.path.join(dicoInit['pathTmpDir'],titleBam+"_last.maf") #250110added
        ...
        if os.path.getsize(pathSCfasta)!=0:
            ...
            cmd = dicoInit['pathBlastN']+" "+dicoInit['pathLASTdb']+" "+pathSCfasta+" -P8 > "+pathMAF #250110changed
            cmd2 = "python "+dicoInit['pathMaftoBlastpy']+" "+pathMAF+" "+pathSCDELBLAST              #250110changed
            os.system(cmd)
            os.system(cmd2) #250110added
