...
def arg_manager(argv,pathRootDir,boolColor,boolQT,spinner):
    ...
    dicoInit = {
                ...
                'pathBlastN':"/data2/hrknkg/mitosalt/MitoSAlt_1.1.1/bin/last/src/lastal",\
                'pathMakeblastdb':"makeblastdb",\
                'pathMaftoBlastpy':"/data2/hrknkg/eklipse/eKLIPse_custom_250110/maftoblast.py",\
                'pathLASTdb':"/data2/hrknkg/mitosalt/MitoSAlt_1.1.1/genome/mouse_mt",\
